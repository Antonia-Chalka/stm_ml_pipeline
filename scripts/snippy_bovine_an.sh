...
do
    ...
    do
          ...
          echo snippy command: snippy --cpus 20 --ram 60 --outdir  "$outhostdir" --prefix "$assembly" --ref  "$ref_seq" --ctgs "$fullfile" --force
          snippy command: snippy --cpus 20 --ram 60 --outdir  "$outhostdir" --prefix "$assembly" --ref  "$ref_seq" --ctgs "$fullfile" --force
