...
outdir="/exports/eddie/scratch/s1438773/panaroo_moderate_out/" #change for test 
...
echo command: panaroo -i $(find prokka_out/ -type f -name "*.gff") -o $outdir -t 10 --clean-mode moderate 

mkdir -p $outdir

#TODO-CHANGE COMMAND
panaroo -i $(find prokka_out/ -type f -name "*.gff") -o $outdir -t 10 --clean-mode moderate
