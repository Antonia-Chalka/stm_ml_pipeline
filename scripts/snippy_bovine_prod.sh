...
do
    ...
    do
          ...
          echo snippy command: snippy --report --cpus 10 --ram 39 --outdir  "$outhostdir" --prefix "$assembly" --ref  "$ref_seq" --ctgs "$fullfile" --force
          snippy command: snippy --report --cpus 10 --ram 39 --outdir  "$outhostdir" --prefix "$assembly" --ref  "$ref_seq" --ctgs "$fullfile" --force
